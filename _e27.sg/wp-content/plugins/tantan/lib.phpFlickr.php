 ...
 * 
 *
 * Modifications by Joe Tan: 
 *     Took out authentication functions
 *     Prepended "tantan" to avoid potential conflicts with other wordpress plugins
 */
...
// If you get PEAR errors, try deleting the line above and remove the "//" on the line below
...
class tantan_phpFlickr {
    ...
    function tantan_phpFlickr ($api_key, $secret = NULL, $die_on_error = true) 
    {
        ...
        $this->xml_parser = new tantan_xml(false, true, true);
    }
