...
<style>
#headerbar-menu a {
background-color: rgba(33,145,62,1) !important;
-webkit-box-shadow: rgba(33,145,62,.2) 0px 1px 0px, inset rgba(33,145,62,.2) 0px 1px 0px;
box-shadow: rgba(33,145,62,.2) 0px 1px 0px, inset rgba(33,145,62,.2) 0px 1px 0px;
