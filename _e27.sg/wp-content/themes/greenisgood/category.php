			...
			<div class="container container_2 clearfix">
				<div class='grid_1' style="width: 719px; padding-right: 15px;">
					...
					<div id="featured" class="clearfix">
						<div class="prel">
							<h1><span>FEATURED STORY FOR <span class="gray"><?php echo single_cat_title( '', false ) ?></span></span></h1>
							<?php $saved = $wp_query; ?>		
					...
					<div id="author_about_stories">
						<h1><span>ALL STORIES ON <span class="gray"><?php echo single_cat_title( '', false ) ?></span></span></h1>
					<div id="posts">
					<?php $saved = $wp_query; ?>
					<?php 
