				<div id="sidebar" class='grid_1' style="width: 320px; padding-left: 15px; border-left: 1px solid #000000; ">
					...
					<div>
						<div class="section f">
						  <h1><span>Subscribe To e27</span></h1>
						  <div id="follow-e27-f">    
						    <div class="fb-like-box">
						      <div class="fb-like" data-href="http://www.facebook.com/e27" data-send="false" data-width="280" data-show-faces="false" data-font="arial"></div>
						    </div>
						    <div class="gplusone">
						      <g:plusone href="https://plus.google.com/115156064497501931516" annotation="inline" width="300"></g:plusone>
						    </div>
						    ...
						    <div class="follow-options">
						      <ul class="social">
						        <li class="linkedin">
						          <a rel="nofollow external" title="LinkedIn" href="http://www.linkedin.com/company/e27-singapore" target="_blank">LinkedIn</a>
						        </li>
						        <li class="youtube">
							...
							<div class="newsletter">
								...
								<form style="display: inline;" action="http://e27.us1.list-manage.com/subscribe/post" method="POST" target="_blank" class="validate">
							...
							<form style="display: inline;"  action="http://e27.us1.list-manage.com/subscribe/post?u=5d6bc43500e46f74ebde550e9&amp;id=14823280cf" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#twitter-count').show();
					...
					$year = date('Y');
					?>
					<?php query_posts(array('showposts' => 5, 'orderby' => 'meta_value_num', 'order' => 'DESC', 'meta_key' => '_shares_total', 'year' => $year, 'w' => $week)); ?>
					<!-- <?php echo $GLOBALS['wp_query']->request; ?> -->
					<?php if (have_posts()) : $count = 0; ?>
					<div id="top_posts_container" class="container container_2 clearfix" style="margin-top: 20px;">
						<h1><span>Top <span class="gray">Posts</span></span></h1>
					...
					<div id="upcoming_events_container" class="container container_2 clearfix" style="margin-top: 20px;">
						<h1><span>Upcoming <span class="gray">Events</span></span></h1>
						<?php while (have_posts()) : the_post(); $count++; ?>
