...
<!-- div id="headtop">
	<table cellspacing="0" cellpadding="0">
		<tr>
			<td id="headtopa1">
				<a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/optimatic_logo.jpg" id="op_logo"></a>
			</td>
			<td id="headtopa2">
				A Community of TheOptimatic.com
			</td>
		</tr>
		<tr>
			<td id="headtopb1" colspan="2">
			</td>
		</tr>
	</table>
</div -->
	...
	<div id="heada">
		<table cellspacing="0" cellpadding="0">
			<tr>
				...
				<td id="heada1">
					<a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_directory'); ?>/images/e27_header_logo.gif" id="e27_logo"></a>
				</td>
				<!-- td id="headam2">
				</td -->
				<td id="heada2">
					...
					<?php if ( $user_ID ) : ?>
						<h2>Welcome <strong><?php echo $user_identity ?></strong>!</h2>
					<?php endif // $user_level >= 1 ?>
					-->
					
					<!-- Insert 468 by 60 pixels ad here -->
					<!-- a href="#" class="ad">
						<img src="<?php bloginfo('template_directory'); ?>/images/468_60_ad.jpg" />
					</a -->
	...
	<div id="headb">
		<table cellspacing="0" cellpadding="0">
			<tr>
								...
								<div id="nav2">
									<div class="suckertreemenu">
										<ul class="nav2" id="treemenu1">
											<?php if (is_home()) {  ?>
												<li class="current_home_item"><a href="<?php bloginfo('url'); ?>">Home</a></li>
											<?php } else {  ?>
				...
				<td id="headb2">
					<?php do_action('fbc_display_login_state') ?>
					<?php do_action('fbc_display_login_button') ?>
					<!--a href="#" class="top_link">About Us</a>
					<a href="#" class="top_link">Contact Us</a-->
				</td>
				<td id="headbm4">
				</td>
			</tr>
	...
	<!-- div id="headc">
		<table cellspacing="0" cellpadding="0">
			<tr>
				...
				<td id="headc2">
					<form method="get" id="loginform" action="<?php bloginfo('url'); ?>/">
						Welcome! Login to your e27
						<img src="<?php bloginfo('template_directory'); ?>/images/text_l.gif" class="text_l">
						<input type="text" name="username" id="username" class="text_x" onClick="clearbox('username')" onBlur="restorehint('username')"/>
						<img src="<?php bloginfo('template_directory'); ?>/images/text_r.gif" class="text_r">						
						
						<img src="<?php bloginfo('template_directory'); ?>/images/text_l.gif" class="text_l">
						<input type="password" name="password" id="password" class="text_x" onClick="clearbox('password')" onBlur="restorehint('password')"/>
						<img src="<?php bloginfo('template_directory'); ?>/images/text_r.gif" class="text_r">
							
						<input type="image" src="<?php bloginfo('template_directory'); ?>/images/login.gif" id="login">
					</form>
				</td>
			</tr>
		</table>
