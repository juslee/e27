...
var zgi_url = 'http://www.flickr.com/apps/badge/badge_iframe.gne?zg_bg_color='+zg_bg_color+'&zg_person_id=14411541%40N06';
document.write('<iframe style="background-color:#'+zg_bg_color+'; border-color:#'+zg_bg_color+'; border:none;" width="200" height="190" frameborder="1" scrolling="no" src="'+zgi_url+'" title="Flickr Badge"><\/iframe>');
...
<div class="Wrapper">
    ...
    <div class="Mid_bar">
        ...
        <div class="Header">
        	...
        	<div class="Logo"><a href="<?php bloginfo('url'); ?>"><img src="http://www.e27.sg/blog/wp-content/uploads/2010/03/e27-Logo-Final.jpg" id="e27_logo" /></a></div>

            <a href="" class="CFBox right" style="position:relative;"><img src="<?php bloginfo('template_directory'); ?>/images/Homepage_connect_facebook.gif" alt="facebook" /></a>
	...
	<?php do_action('fbc_display_login_button') ?>
            ...
            <div class="Bannerad">
            <a href="http://www.e27.sg/unconference/2009/"><img src="<?php bloginfo('template_directory'); ?>/images/ads.jpg" alt="ads"/></a>
            </div>
