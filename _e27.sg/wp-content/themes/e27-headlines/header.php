...
<link rel="shortcut icon" href="/e27_icon.ico">

<!-- awesome typekit fonts -->
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/includes/js/EventHelpers.js"></script>
<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/includes/js/TypeHelpers.js"></script>


<?php //if (strpos($_SERVER['HTTP_USER_AGENT'], "Windows", 0) === FALSE) { ?>
<script type="text/javascript" src="http://use.typekit.com/qhg8dya.js"></script>
...
<img src="http://ad.retargeter.com/seg?add=323268&t=2" width="1" height="1" />
