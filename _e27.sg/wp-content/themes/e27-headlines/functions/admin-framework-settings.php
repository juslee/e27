...
function woothemes_framework_settings_page(){
	...
	$framework_options[] = array( 	"name" => "Enable Options Output",
									"desc" => "Enable the ability to show your Woo Options for support purposes. You can view the themes option by URL e.g. http://yoursite.com/?options=woo",
