...
function the_widgets_init() {
    ...
    register_sidebar(array('name' => 'Sidebar Bottom','id' => 'sidebar-bottom','before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3>','after_title' => '</h3>'));
}
