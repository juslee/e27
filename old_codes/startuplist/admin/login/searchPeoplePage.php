...
$sql_res=mysql_query("select * from profile where profile_name like '%$q%' and profile_org='1' order by profile_id");

if (mysql_num_rows($sql_res) == 0) { 
?>
<div id="<?php echo $q ?>" class="display_boxp" align="left" >
...
?>
<div id="<?php echo $fname; ?>" class="display_boxp" align="left" >
