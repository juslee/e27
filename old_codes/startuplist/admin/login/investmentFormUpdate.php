...
$(document).ready(function () {
	...
	$(".display_box").live("click", function () {
		...
		$('#competitor' + (competi_count - 1)).val(thi);
	...
	$('#new_competitors').live('click', function () {
		...
		$('#competitors_part').before('<br><ul class="company_details" id="delUlC' + competi_count + '"><li><label>Competitor' + competi_count + ':</label><input type="text" class="search" id="competitor' + competi_count + '" name="0" /><a href="#nogo" id="minus"  style="float:right;margin: 5px 0px 10px 20px;" class="delUlC' + competi_count + '" title="comp" name="0"><img src="../img/button_minus.png" style="height:25px;width:25px;" tabindex="15"/></a></li></ul><div id="display"></div><div class="clear"></div>');
		competi_count++;
	...
	//****************updating section******************//
	$('#updateInvcompany').live('click', function () {
		update();
	...
	function update() {
		...
		while (fundCounterLoop < fund_count) {
			fund[fundCounter] = $('#fund' + fundCounterLoop).attr('name');
			fund[fundCounter + 1] = $('#fund' + fundCounterLoop).val();
			fund[fundCounter + 2] = $('#round' + fundCounterLoop).val();
			fund[fundCounter + 3] = $('#asign' + fundCounterLoop).val();
			fund[fundCounter + 4] = $('#amount' + fundCounterLoop).val();
			fund[fundCounter + 5] = $('#date' + fundCounterLoop).val();
			fund[fundCounter + 6] = $('#type' + fundCounterLoop).val();
			fund[fundCounter + 7] = $('#person' + fundCounterLoop).val();
			
			fundCounter = fundCounter + 8;
			fundCounterLoop++;
		}
		...
		if (profile_name == '' || profile_country == '') {
			...
			$.ajax({
				type : "post",
				url : "companyInvInfoUpdate.php",
				data : updatedData,
				success : function (data) {
					//alert(data);
					if (data == 0) {
						$('#info').html('Investment Org Already Exists.').fadeIn(400).delay(4000).fadeOut(400);
					} else {
...
<div id="wrapper">
	...
	<div id="main_content">
		...
		<h2 class="form_title">Edit Investment Org</h2>
			...
			<div id="id-form" class="order">
				<div class="form_midblue">
					...
					<ul class="company_details">
						<li><label>Name:</label><input id="profile_name" type="text" name="profile_name" class="text" value=""/></li>
						<li><label>Description:</label><textarea id="profile_description" type="text" name="profile_description" class="text" value="" rows="10"></textarea></li>
						<li><label>Category:</label><select id="profile_category" name="profile_category" tabindex="3"  class="text">
							<option value=""></option>
						...
						<li><label>Website:</label><input id="profile_homepage_url" type="text" name="profile_homepage_url" class="text" value=""/></li>
						<li><label>Blog URL:</label><input id="profile_blog_url" type="text" name="profile_blog_url" class="text" value=""/></li>
						<li><label>Twitter Username:</label><input id="profile_twitter_username" type="text" name="profile_twitter_username" class="text" value=""/></li>
						<li><label>Facebook Username:</label><input id="profile_facebook_username" type="text" name="profile_facebook_username" class="text" value=""/></li>
						<li><label>Email:</label><input id="profile_email" type="text" name="profile_email" class="text" value=""/><span id="validEmail"></span></li>
						<li><label>No. of Employees:</label><input id="profile_number_of_employees" type="text" name="profile_number_of_employees" class="text" value=""/></li>
						<li><label>Founding Date:</label><select id="profile_founded_month" name="profile_founded_month" tabindex="10"  class="text" ><option value="" selected="selected"></option>
								...
								<option value="12">December</option></select><select id="profile_founded_day" name="profile_founded_day" tabindex="11"  class=""><option selected="selected" value="" ></option>
								...
								<option value="31">31</option></select><select id="profile_founded_year" name="profile_founded_year" tabindex="12"  class=""><option selected="selected" value="" ></option>
						...
						<li><label>Country:</label><select id="profile_country" type="text" name="profile_country" tabindex="14"  class="text" >
						...
						<li><label >Logo:</label>
								   ...
								   <input id="timg" type='hidden'  value="" /><input type="file" name="profile_logo" id="profile_logo" class="text" tabindex="13"/><div id="preview" style='border-top-left-radius:3px;border-bottom-right-radius:3px;border-top-right-radius:3px;border-bottom-left-radius:3px;height:100px;width:100px;border:solid 1px #ffffff;display:block;box-shadow: 0px 2px 6px ;-moz-box-shadow:0px 2px 6px;-webkit-box-shadow: 0px 2px 6px;font-size:10px; float: right; padding: 4px;margin: -40px 10px 10px 20px;' ></div>
								   </form></li><div class="clear"></div>
						<li><label >Screenshots:</label>
							<form id="imageform1" method="post" enctype="multipart/form-data" action='ajaximageScreen.php'><input id="timg1" type='hidden'  value="" />
							<input type="file" name="profile_screenshots" id="profile_screenshots" class="text" tabindex="17"/><div id="preview1" style='border-top-left-radius:3px;border-bottom-right-radius:3px;border-top-right-radius:3px;border-bottom-left-radius:3px;height:100px;width:100px;border:solid 1px #ffffff;display:block;box-shadow: 0px 2px 6px ;-moz-box-shadow:0px 2px 6px;-webkit-box-shadow: 0px 2px 6px;font-size:10px;float: right; padding: 4px;margin: -40px 10px 10px 20px;' ></div>
							</form></li><div class="clear"></div>
							
						<li><label >Status:</label>
							<select id="profile_status" name="profile_status" tabindex="18"  class="" >
							<option value=""></option>
							<option value="Live">Live</option>
							<option value="Close">Close</option></select></li>
							<div class="clear"></div>
						<li><label >Active:</label>
							<select id="profile_active" name="profile_active" tabindex="19"  class="" >
							<option value=""></option>
				...
				<div class="form_midyellow">
					<!-- // ========== PEOPLE  ============ // -->
					<ul class="company_details">
						<li><label >People:</label><img id='new_people' src="../img/button_plus.png" style='height:25px;width:25px;' tabindex="15"/>
							</li><div class='sign_toggle'><div id='people_part'></div></div>
						<div class="clear"></div>
					</ul>
				</div>
				<!--<div class="form_midblue">
					<!-- // ========== COMPETITOR ========= // --
					<ul class="company_details">
						<li><label>Competitor Name:</label><img id='new_competitors' src="../img/d_addd.png" style='height:25px;width:25px;' tabindex="16"/>
							</li><div class='sign_toggle'><div id='competitors_part'></div></div>
						<div class="clear"></div>
					</ul>
				</div>-->
				<!--<div class="form_midyellow">
					<!-- // ========== FUNDING ============ // --
					<ul class="company_details">
						<li><label>Funding Details:</label><img id='new_fund' src="../img/button_plus.png" style='height:25px;width:25px;'/>
							</li><div class='sign_toggle'><div id='funding_part'></div></div>
						<div class="clear"></div>
					</ul>	
				</div>-->
				<div class="form_midblue">
					<!-- // ========== MILESTONES ========= // -->
					<ul class="company_details">
						<li><label>History Name:</label><img id='new_milestones' src="../img/button_plus.png" style='height:25px;width:25px'/>
							</li><div class='sign_toggle'><div id='milestones_part'></div></div>
						<div class="clear"></div>
					</ul>
				</div>
				<div class="form_midblue">
					<!-- // ========== BUTTONS ============ // -->
					<a href="#_" id="updateInvcompany" class="fright"></a>
