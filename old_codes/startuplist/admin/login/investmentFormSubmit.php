...
$(document).ready(function () {
	...
	function submit() {
		...
		while (sd < Subfund_count) {
			...
			Subfund[d] = $("#fund" + sd).val();
			Subfund[d + 1] = $("#round" + sd).val();
			Subfund[d + 2] = $("#asign" + sd).val();
			Subfund[d + 3] = $("#amount" + sd).val();
			Subfund[d + 4] = $("#date" + sd).val();
			Subfund[d + 5] = $("#type" + sd).val();
			Subfund[d + 6] = $("#person" + sd).val();
			//alert(del[a]);
			sd++;
			d = d + 7;
		}
			...
			<div id="id-form" class="order">
				<div class="form_midblue">
					...
					<ul class="company_details">
						...
						<li><label>Category:</label><select id="profile_category" name="profile_category" tabindex="" class="text">
							<option value=""></option>
						...
						<li><label>Founding Date:</label><select id="profile_founded_month" name="profile_founded_month" tabindex=""  class="text" ><option value="" selected="selected"></option>
								...
								<option value="12">December</option></select><select id="profile_founded_day" name="profile_founded_day" tabindex=""  class=""><option selected="selected" value="" ></option>
								...
								<option value="31">31</option></select><select id="profile_founded_year" name="profile_founded_year" tabindex=""  class=""><option selected="selected" value="" ></option>
						...
						<li><label>Country:</label><select id="profile_country" type="text" name="profile_country" tabindex=""  class="text" >
						...
						<li><label >Logo:</label>
								   ...
								   <input id="timg" type='hidden'  value="" /><input type="file" name="profile_logo" id="profile_logo" class="text" tabindex=""/><div id="preview" style='' ></div></form></li><div class="clear"></div>
						<li><label >Screenshots:</label>
							...
							<input type="file" name="profile_screenshots" id="profile_screenshots" class="text" tabindex=""/><div id="preview1" style='' ></div></form></li><div class="clear"></div>		
						<li>
							<label >Status:</label>
				...
				<div class="form_midyellow">
					<!-- // ========== PEOPLE  ============ // -->
					<ul class="company_details">
						<li><label >People:</label><img id='new_people' src="../img/button_plus.png" style='height:25px;width:25px;' tabindex=""/>
							</li><div class="sign_toggle"><div id='people_part'></div></div><div style=" width:300px; float:right;left:180px;position:absolute; z-index:2;" align="right"></div>
						<div class="clear"></div>
					</ul>
				</div>
				<!--<div class="form_midblue">
					...
					<ul class="company_details">
						<li><label>Competitor Name:</label><img id='new_competitors' src="../img/d_addd.png" style='height:25px;width:25px;' tabindex="16"/>
							</li><div class="sign_toggle"><div id='competitors_part'></div></div><div style=" width:300px; float:right;left:180px;position:absolute; z-index:2;" align="right"></div>
						<div class="clear"></div>
					</ul>
				</div>-->
				<!--<div class="form_midyellow">
				...
				<div class="form_midblue">
					...
					<a href="#_" id="addInvcompany" class="fright"></a>
					<div id='info' style=''></div>
					<span class="error" style="display:none">Please Enter Valid Data</span><span  class="success" style="display:none">Investment Org Successfully Created.</span>
