...
$table="profile"; // this is the tablename that you want to export to csv from mysql.
	...
	<div id="wrapper">
		...
		<div id="main_content">
			...
			<div id="form_container">
				...
				<a href="http://Startuplist.10dd.co/admin/login/investmentFormSubmit.php" id="addInvestDash"  title="Add Investment Org"></a>
					<form method="post" action="investmentDashboard.php" >
				...
				<div id="table-content">
					...
					<div class="tab-container">
						...
						<div id="container"  class="tab-content"></div>
