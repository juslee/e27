<?php
$query_pag_data = "SELECT profile_id,profile_name,profile_email,profile_active from profile WHERE profile_org='0' ORDER BY profile_id DESC LIMIT $start, $per_page";
...
<td class='options-width'><a href='#nogo' title='Edit' class='icon-1 info-tooltip view_profile_investment' id='$profile_id'></a>
<a href='#nogo' title='delete' class='icon-2 info-tooltip delete_profile_investment' id='$profile_id'></a><a href='#nogo' title='front' class='icon-5 info-tooltip frontPage_ProfileInv' id='$profile_id'></a></td>
</tr>";
$t++;}
...
var test;
$(".view_profile_investment").live("click",function(e){
test = $(this).attr('id');
	//alert('front');
	location.href = "http://startuplist.10dd.co/admin/login/investmentFormUpdate.php?test="+test;
	return false;
});	
$(".frontPage_ProfileInv").live("click", function (e) {
	//alert('front');
