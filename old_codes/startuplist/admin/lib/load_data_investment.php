...
include('table_data_investment.php');
...
if ($cur_page >= 7) {
 ...
 /*-----------------------------------------------------------------------------------------------------------*/ 
$finaldata .= "<div class='pagination_investment'><ul>";
...
$query_pag_num = "SELECT COUNT(*) AS count FROM profile where profile_org='0'";
$result_pag_num = mysql_query($query_pag_num);
$row = mysql_fetch_array($result_pag_num);
$count = $row['count'];
$goto = "<input type='text' class='goto' size='1' style='margin-top:-1px;margin-left:60px;'/><input type='button' id='go_btn_investment' class='go_button' value='Go'/>";
