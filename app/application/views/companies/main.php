...
<form action="<?php echo site_url(); ?>companies/search/" class='inline' >
	...
	<option value="all" selected="selected">All of the above</option>
...
<table>
	...
	for($i=0; $i<$t; $i++){
		...
		<tr id="tr<?php echo htmlentitiesX($companies[$i]['id']); ?>" class="row" >
			...
			<td><a href="<?php echo site_url(); ?>companies/edit/<?php echo $companies[$i]['id']?>" ><?php echo htmlentitiesX($companies[$i]['name']); 
			?></a><?php
			
			if($companies[$i]['status']=="Closed"){
